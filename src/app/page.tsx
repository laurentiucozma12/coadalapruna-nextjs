...
export default function Home() {
    return (
        <>
            <div className="mt-0 lg:mb-2 lg:mt-2 lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:grid-rows-2 lg:gap-2">
            ...
            <div className="columns-1 gap-2 lg:mb-2 lg:columns-3">
                <Card
                    title="Despre mine 👨"
                    description={
                        <>
                            Mă numesc Nelu Bulea și creez ornamente din lemn
                            personalizate pentru sticle de țuică/pălincă. Mai
                            jos poți vedea mai multe imagini cu arta mea, iar
                            dacă dorești să vezi și mai multe, poți să îmi
                            urmărești videoclipurile de pe{' '}
                            <Link
